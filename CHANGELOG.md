...
### Added
- `theme` taxonomy on first line of lyrics body

## [0.2.27] - 2026-04-19

### Added
- Flag emoji via `flag-emoji` partial
...
### Changed
- Refactor CSS
- Replace `duets` class with `grid` and `gallery` elements with two children
...
### Added
- Podcast feed output format

## [0.2.22] - 2026-01-22

### Added
- Open Graph output in `head`

## [0.2.21] - 2026-01-12

### Changed
- `gallery` uses flexbox, with optional `duets` class for row of two items

## [0.2.20] - 2026-01-07

### Added
- LinkedIn permalinks from `linkedin_id`
- /now archive
- Now and Occasion in timeline

### Changed
- Limit journal items processing in development

## [0.2.19] - 2025-09-16

### Added
- Blog footer shows next / previous post
