...
# Features
- local time and place on all posts site-wide based on post location (add to [`assets/departures.csv`](https://github.com/rosano/home/blob/master/assets/departures.csv) in destination timezone)
...
- browse [by year](https://rosano.ca/log/2024), [by month](https://rosano.ca/log/2023/06), or [by day](https://rosano.ca/log/2024/03/12) (`date`)
- [embed rendering](https://rosano.ca/log/01k208ka0ffjawrw9aq479t8te/) (`link`)
